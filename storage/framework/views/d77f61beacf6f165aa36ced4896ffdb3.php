...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <p class="mt-4 text-sm text-center">
            Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-blue-500 underline">Daftar Siswa</a>
        </p>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\ukk_pengaduansekolah\resources\views/auth/login.blade.php ENDPATH**/ ?>